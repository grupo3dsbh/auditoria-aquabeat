            ...
            <div class="col-md-12">
                ...
                <div class="alert alert-info">
                    ...
                    <ul class="mb-0">
                        ...
                        <li><strong>Inadimplente = 3 ou mais parcelas em atraso</strong> (tolera até 2 parcelas em atraso)</li>
                        ...
                        <li>Exemplo: Vendido 17/09, hoje 22/12, pagou 2 de 4 esperadas = <span class="badge bg-success">ADIMPLENTE</span> (2 em atraso)</li>
                        <li>Exemplo: Vendido 17/08, hoje 22/12, pagou 2 de 5 esperadas = <span class="badge bg-danger">INADIMPLENTE</span> (3 em atraso)</li>
                    </ul>
                </div>
