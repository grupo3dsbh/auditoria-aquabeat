...
<div class="container-fluid mt-4">
    ...
    <div class="card mt-4">
        ...
        <div class="card-body">
            ...
            <pre class="bg-light p-3 rounded"><code>POST <?php echo $_SERVER['REQUEST_SCHEME'] . '://' . $_SERVER['HTTP_HOST']; ?>/api/gerar_pdf_relatorio.php</code></pre>
...
Content-Type: application/json</code></pre>
  ...
  "success": true,
  "html": "&lt;html&gt;...&lt;/html&gt;",
  "pdf_url": "/relatorios/relatorio_2025-01-15.pdf",
  "estatisticas": {
    "total_titulos": 1234,
    "inadimplentes": 456,
